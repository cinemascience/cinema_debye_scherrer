...
To start
  ...
  1. Next to the y-axis is a drop-down menu with "CHISQ" selected. Select the volume column ("BaBrCl_VOL") the scatter plot should change. You should see a linear trend between volume and temperature.
  ...
  1. On the "Temp [C]" axes of the parallel coordinates plot click outside the gray box. The original seven points should appear in the table and the parallel coordinates plot.
